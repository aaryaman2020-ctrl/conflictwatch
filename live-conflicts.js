...
window.LIVE_CONFLICT_DATA = [
  ...
  },
  {
    ...
    attackTypes: ["Ground Assault"],
    weapons: [],
    description: "RSF cross-border attack into Chad while pursuing JDF unit. 7 Chadian soldiers killed at Birak garrison near Tiné Djagaraba. International spillover of Sudan conflict.",
  ...
  },
  {
    ...
    dailyActivity: [
      { date: "2026-02-09", event: "Clashes at multiple villages around Minembwe. FARDC recaptured Point Zéro from Twirwaneho." },
      { date: "2026-02-05", event: "M23-aligned fighters attack FARDC in Point Zéro and Tuwetuwe — mass displacement." }
    ],
    region: "Africa", country: "DR Congo", countryCode: "CG",
    conflictName: "Eastern Congo Conflict",
